...
<img width="2551" height="1283" alt="image" src="https://github.com/user-attachments/assets/b2180692-1509-440c-bceb-5129bd597ba8" />
...
> **AWS 과금 주의(Cost Alert):** 위 설정은 온프레미스 장비 구성입니다. 추후 AWS VPC와 연동을 시작하는 순간(VPN 터널 Up), AWS 측에서는 VPN 연결 시간(Hourly) 및 아웃바운드 트래픽에 대한 과금이 발생합니다.
